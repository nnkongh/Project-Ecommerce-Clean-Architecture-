...
{
    public sealed class ProductFilterWithPagingSpec : BaseSpecification<Product>
    {
        public ProductFilterWithPagingSpec(
            string? sortBy, decimal? minPrice, decimal? maxPrice,
            int? categoryId, string? searchTerm,
        ...
        internal static Expression<Func<Product, bool>> BuildCriteria(
    ...
    public sealed class ProductFilterCountSpec : BaseSpecification<Product>
    {
        public ProductFilterCountSpec(
            decimal? minPrice, decimal? maxPrice,
            int? categoryId, string? searchTerm)
            : base(ProductFilterWithPagingSpec.BuildCriteria(minPrice, maxPrice, categoryId, searchTerm))
        {
        }
    }
}